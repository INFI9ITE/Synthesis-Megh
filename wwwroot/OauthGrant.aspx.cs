...
namespace wwwroot
{
    public partial class OauthGrant : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            QBRequest.AuObj.ClientId = ConfigurationManager.AppSettings["clientId"];
            QBRequest.AuObj.ClientSecretKey = ConfigurationManager.AppSettings["clientSecret"];
